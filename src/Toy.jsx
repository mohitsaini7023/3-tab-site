...
<div className="container"  >
  <div className="as">
    ...
    <p>See All Toys <FaLongArrowAltRight />
</p>
  </div>
  ...
  <div className="card toy-card" style={{ border: 'none', backgroundColor: 'white' }}>
    <div className="card-body align-item-center text-center">
      ...
      <button className="btn1">$30.00 USD</button>
    </div>
  </div>
</div>
   <div className="col-lg-3 col-md-6 col-sm-12 mt-3">
  <div className="card toy-card" style={{ border: 'none', backgroundColor: 'white' }}>
    <div className="card-body align-item-center text-center">
      ...
      <button className="btn1">$38.00 USD</button>
    </div>
  </div>
</div>
   <div className="col-lg-3 col-md-6 col-sm-12 mt-3">
  <div className="card toy-card" style={{ border: 'none', backgroundColor: 'white' }}>
    <div className="card-body align-item-center text-center">
      ...
      <button className="btn1">$24.00 USD</button>
    </div>
  </div>
</div>
   <div className="col-lg-3 col-md-6 col-sm-12 mt-3">
  <div className="card toy-card" style={{ border: 'none', backgroundColor: 'white' }}>
    <div className="card-body align-item-center text-center">
      ...
      <button className="btn1">$27.00 USD</button>
    </div>
  </div>
</div>
...
<div className="container py-5 mt-5" >
  ...
  <div className="card toy-card" style={{ border: 'none', backgroundColor: 'white' }}>
    <div className="card-body align-item-center text-center">
      ...
      <button className="btn1">$32.00 USD</button>
    </div>
  </div>
</div>
   <div className="col-lg-3 col-md-6 col-sm-12 mt-3">
  <div className="card toy-card" style={{ border: 'none', backgroundColor: 'white' }}>
    <div className="card-body align-item-center text-center">
      ...
      <button className="btn1">$16.00 USD</button>
    </div>
  </div>
</div>
  ...
  <div className="back text-white text-center pb-5 pt-5">
    <p className="pt-5"><b>About The Shop</b></p>
...
<div className="container bg-white" style={{marginTop:'80px',borderRadius:'30px'}}>
...
& get 10% discount!</h2>
    ...
    <div className="col-lg-6 col-md-6 col-sm-12 mt-3 d-flex">
        <input type="text" placeholder="Enter Your Email Address" className="input w-100" />
        <button className="toy-button1">subscribe</button>
    </div>
  </div>
</div>
